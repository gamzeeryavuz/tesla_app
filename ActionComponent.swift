...
//  TeslaApp
//
//  Created by Gamze Eryavuz on 22.07.2025.
//
...
struct ActionComponent: View {
    var body: some View {
      /*  ActionNotification(open: .constant(true), icon:"fanblades.fill", text: "Turn on the fan ")*/
                ...
                VStack (spacing:20){
                    ...
                    HStack {
                        ...
                        HStack (alignment:.center ,spacing: 20){
                            ...
                            RadialGradient(gradient: Gradient(colors: [Color.white, Color.white.opacity(0.1)]),
                                           center: .leading, startRadius: 31, endRadius: 32)
